...
import cryptoSvg from "../public/crypto-devs.svg"
  ...
  const renderButton = () => {
    if (walletConnected) {
      if (joinedWhitelist) {
        ...
        return (
          <Button onClick={addAddressToWhitelist} className="light-retro">
            Join the Whitelist
          </Button>
        );
      }
      ...
      return (
        <Button onClick={connectWallet} className="light-retro">
          Connect your wallet
        </Button>
      );
    }
